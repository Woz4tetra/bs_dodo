#ifndef DB_PARSING_DODOBOTGETSTATE_HXX
#define DB_PARSING_DODOBOTGETSTATE_HXX
...
{
  typedef DodobotGetStateRequest_<std::allocator<void>> Request;
  typedef DodobotGetStateResponse_<std::allocator<void>> Response;
  Request request;
  Response response;
...
struct MD5Sum< ::db_parsing::DodobotGetState >
{
  static const char* value()
  {
    return "fc5d70ff9d5e20ddc7b3b2a64196a440";
  }
...
template<>
struct MD5Sum< ::db_parsing::DodobotGetStateRequest_<std::allocator<void>> >
{
  static const char* value()
  {
    return "d41d8cd98f00b204e9800998ecf8427e";
  ...
  static const char* value(const ::db_parsing::DodobotGetStateRequest_<std::allocator<void>>&) { return value(); }
};

template<>
struct DataType< ::db_parsing::DodobotGetStateRequest_<std::allocator<void>> >
{
  static const char* value()
  {
    return "db_parsing/DodobotGetStateRequest";
...
template<>
struct MD5Sum< ::db_parsing::DodobotGetStateResponse_<std::allocator<void>> >
{
  static const char* value()
  {
    return "4c01d362382e7c93b8d729b6e9ad99c8";
  ...
  static const char* value(const ::db_parsing::DodobotGetStateResponse_<std::allocator<void>>&) { return value(); }
};

template<>
struct DataType< ::db_parsing::DodobotGetStateResponse_<std::allocator<void>> >
{
  static const char* value()
  {
    return "db_parsing/DodobotGetStateResponse";
...
#endif // DB_PARSING_DODOBOTGETSTATE_HXX
