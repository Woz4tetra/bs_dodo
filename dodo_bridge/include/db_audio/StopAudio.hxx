#ifndef DB_AUDIO_STOPAUDIO_HXX
#define DB_AUDIO_STOPAUDIO_HXX
...
struct StopAudio
{
  typedef StopAudioRequest_<std::allocator<void>> Request;
  typedef StopAudioResponse_<std::allocator<void>> Response;
  Request request;
  Response response;
...
template<>
struct MD5Sum< ::db_audio::StopAudioRequest_<std::allocator<void>> >
{
  static const char* value()
  {
    return "c1f3d28f1b044c871e6eff2e9fc3c667";
  ...
  static const char* value(const ::db_audio::StopAudioRequest_<std::allocator<void>>&) { return value(); }
};

template<>
struct DataType< ::db_audio::StopAudioRequest_<std::allocator<void>> >
{
  static const char* value()
  {
    return "db_audio/StopAudioRequest";
...
template<>
struct MD5Sum< ::db_audio::StopAudioResponse_<std::allocator<void>> >
{
  static const char* value()
  {
    return "e3a98d806e1c4fee01a17d597e27ea8e";
  ...
  static const char* value(const ::db_audio::StopAudioResponse_<std::allocator<void>>&) { return value(); }
};

template<>
struct DataType< ::db_audio::StopAudioResponse_<std::allocator<void>> >
{
  static const char* value()
  {
    return "db_audio/StopAudioResponse";
